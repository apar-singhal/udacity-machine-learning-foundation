...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        .movie-tile:hover .img-description {
            visibility: visible;
            opacity: 1;
        }
        .scale-media {
...
main_page_content = '''
  <body>
    ...
    <footer>
        <p>
            <b>Developed By:</b> Apar Singhal
            [ <a href="mailto:aparsinghal@gmail.com">
                aparsinghal@gmail.com
            </a> ]
        </p>
        <p><b>Source Credits:</b> The Movie Database</p>
    </footer>
</body>
</html>
'''
...
<div class="col-md-6 col-lg-4 movie-tile text-center"
    ...
    <b><p class="img-description">{storyline}</p></b>
    <h2>{movie_title}</h2>
